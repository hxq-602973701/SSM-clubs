...
<div class="data_list backMain">
    ...
    <div class="search_content" style="vertical-align: middle;">
        <form action="newsListA.do" method="get">
            ...
            发布日期：<input type="text" id="s_bPublishDate" name="s_bPublishDate" class="Wdate" onclick="WdatePicker()"
                        style="width: 100px;" value="${s_bPublishDate }"/>
            &nbsp;到&nbsp;<input type="text" id="s_aPublishDate" name="s_aPublishDate" class="Wdate"
                                onclick="WdatePicker()" style="width: 100px;" value="${s_aPublishDate }"/>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-mini btn-info" type="button"
                                onclick="javascript:window.location.href='newsPre.do?action=preSave&newsId=${newsBack.newsId}'">
                            修改
                        </button>&nbsp;<button class="btn btn-mini btn-danger" type="button"
                                               onclick="newsDelete(${newsBack.newsId})">删除
                    </button>
                        </button>&nbsp; <input type="button" class="btn btn-mini btn-danger"
                                               onclick="newsVerify('${newsBack.newsId}')"
                                               value="√通过审核" ${newsBack.state==1?"disabled":"" }/>
                    </td>
                </tr>
            </c:forEach>
        </table>
