            ...
            <table cellpadding="5" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label class="checkbox inline">
                            <input type="checkbox" id="isImage" name="isImage" onclick="checkChange()"
                                   value="1" ${news.isImage==1?'checked':'' }>幻灯
                        </label>
                        <label class="checkbox inline">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="button" class="btn btn-primary" value="返回" onclick="javascript:history.back()"/>&nbsp;&nbsp;<font
