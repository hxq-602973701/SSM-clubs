		...
		<table class="table table-hover table-bordered">
			...
			<c:forEach var="linkBack" items="${linkBackList }" varStatus="status">
				<tr>
					...
					<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='link.do?action=preSave&linkId=${linkBack.linkId}'">修改</button>&nbsp;&nbsp;<button class="btn btn-mini btn-danger" type="button" onclick="linkDelete(${linkBack.linkId})">删除</button></td>
				</tr>
			</c:forEach>
		</table>
	</div>
